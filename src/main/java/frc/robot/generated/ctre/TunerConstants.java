...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        ...
        .withKS(0.12).withKV(2.75).withKA(0.32);
    ...
    public static final CANBus kCANBus = new CANBus("CAN-EATER", "./logs/example.hoot");
    ...
    private static final Distance kWheelRadius = Inches.of(1.89375);
