...
public class CmdShooterPIDTuner extends Command {
    ...
    private void analyzeAndReport() {
        ...
        if (phase == Phase.SLOW_UP_STEP) {
            ...
            double currentKV = shooter.getKV();
    ...
    private void appendFinalSummary() {
        ...
        fullReport.append("  Kp: ").append(shooter.getKP()).append("\n");
        fullReport.append("  Ki: ").append(shooter.getKI()).append("\n");
        fullReport.append("  Kd: ").append(shooter.getKD()).append("\n\n");

        fullReport.append("Feedforward Values Used:\n");
        fullReport.append("  kV: ").append(shooter.getKV()).append("\n");
        fullReport.append("  kS: ").append(shooter.getKS()).append("\n\n");
